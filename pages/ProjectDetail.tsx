...
const ProjectDetail: React.FC = () => {
  ...
  const project = Array.isArray(PROJECTS) ? PROJECTS.find(p => p && p.slug === slug) : undefined;
      ...
      <div className="relative z-10 pt-32 max-w-6xl mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-4 gap-8 mb-16">
          ...
          <div className="lg:col-span-3 space-y-12">
            ...
            {/* Disclaimer */}
            {project.disclaimer && (
              <section className="glass-panel p-8 rounded-2xl animate-fade-in-up border-l-4 border-yellow-500" style={{ animationDelay: '0.25s' }}>
                <div className="flex items-center gap-3 mb-4 text-yellow-400">
                  ...
                  <h2 className="text-2xl font-bold font-display text-white">Disclaimer</h2>
                </div>
                <p className="text-slate-300 leading-relaxed text-lg">
                  {project.disclaimer}
                </p>
